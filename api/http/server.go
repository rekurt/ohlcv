...
func NewServer(candlesClient candle.CandleServiceClient, dealService domain.Service, conf infra.Config) *Server {
	...
	candleHandler := handler.NewCandleHandler(candlesClient)
